...
declare module '$env/static/private' {
	export const WEBUI_AUTH: string;
	export const ENABLE_SIGNUP: string;
...
declare module '$env/static/public' {
	export const PUBLIC_WEBUI_BASE_URL: string;
